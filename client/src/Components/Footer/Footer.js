    ...
    <div>
      <div className="main4footer pt-5">
        <div className="container center4footer">
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-12 width4footer my-3">
              <a
                ...
                href="https://www.google.com/maps/place/Webhp.solutions/@31.49155,74.375093,15z/data=!4m5!3m4!1s0x0:0x66664afd33ad07e6!8m2!3d31.4915503!4d74.3750928"
                target="_blank"
              >
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 width4footer my-3">
              <a
                className="anchor4footer"
                href="https://wa.me/+923030649985/?text=Tell me something about Eventarc?"
                target="_blank"
              >
                <div className="innerwidth">
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 width4footer my-3">
              <a
                className="anchor4footer"
                href="mailto:eventarc4u@gmail.com"
                target="_blank"
              >
                <div className="innerwidth">
                  <i class="fas fa-envelope mb-3"></i>
                  <p>Eventarc4u @gmail.com</p>
                </div>
              </a>
            </div>
          </div>
          <div className="row my-5 ">
            <div className="col-lg-3 col-md-12 col-sm-12 footerlefttext">
              <h5>EVENTARC</h5>
              <p>
                Being The Best Event Management Company We Strive To Create High
                Quality And Out Of The Box Prodcutions For Our Clients. Check
                Out Our User Friendly Customizable 3d Modals And See For
                Yourself What Makes Us Stand Out. Supervise Every Detail Of Your
            ...
            <div
              className="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-center align-items-center flex-column
                        "
            >
              <div className="d-flex ">
                <input
                  value={userfooteremail}
                  onChange={(e) => {
                    setuserfooteremail(e.target.value);
                  }}
                  type="text"
                  placeholder="ENTER YOUR EMAIL"
                  className="input4news"
                />
        ...
        <div className="footercopy ">
              ...
              <i class="far fa-copyright mx-2"></i> 2022 EVENTARC All rights
              reserved.
